            ...
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-4" aria-label="Global">
                <div className="flex lg:flex-1">
                    <a href="#" className="-m-1.5 p-1.5">
                        ...
                        <h1 className='text-blue-300 text-4xl'>BIG SALES</h1>
                    </a>
                </div>
                ...
                <form className="hidden lg:flex lg:gap-x-12">
                    ...
                    <input className='p-2 w-full' type='text' name='search' placeholder='Search' />
                    <input type='text' className='p-2 w-full' name='country' placeholder='United Kingdom' />
                ...
                <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                    <div className='text-white'>
                        <a href="#" className="text-sm font-semibold leading-6">Sell</a>
                    </div>
                    <div className='ml-5 text-white'>
                        <a href="#" className="text-sm font-semibold leading-6">Login/Register</a>
                    </div>
                </div>
            </nav>
